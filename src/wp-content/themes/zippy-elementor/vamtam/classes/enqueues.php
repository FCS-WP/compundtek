	...
	public static function admin_scripts() {
		...
		wp_localize_script(
			'vamtam-admin', 'VAMTAM_ADMIN', array(
				'addNewIcon' => esc_html__( 'Add New Icon', 'fabrik' ),
				'iconName'   => esc_html__( 'Icon', 'fabrik' ),
				'iconText'   => esc_html__( 'Text', 'fabrik' ),
				'iconLink'   => esc_html__( 'Link', 'fabrik' ),
				'iconChange' => esc_html__( 'Change', 'fabrik' ),
				'fonts'      => $GLOBALS['vamtam_fonts'],
				'home_url'   => home_url(),
				'elementsTxt' => esc_html__( 'Enter your Envato Elements Token.', 'fabrik' ),
				'tfPcTxt' => esc_html__( 'Enter your purchase code from ThemeForest to receive theme updates and support.', 'fabrik' ),
				'unRegPcTxt' => esc_html__( 'You are about to unregister your purchase code. Are you sure you want to continue?', 'fabrik' ),
				'unRegTokenTxt' => esc_html__( 'You are about to unregister your Envato Elements Token. Are you sure you want to continue?', 'fabrik' ),
